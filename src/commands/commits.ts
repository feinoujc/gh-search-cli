...
export default class Code extends Command {
  static description = 'search github commits. https://developer.github.com/v3/search/#search-commits'
...
`
  ...
  static flags = {
    ...
    sort: flags.enum({
      ...
      description: 'The sort field. Can be author-date or committer-date. Default: results are sorted by best match.'
    }),
    ...Command.flags
  }
